...
- [ ] 전체 상품 정보 리스트로 여러 상품을 등록한다
- [ ] `예외처리` 등록 이름이 null 일 경우 예외가 발생한다
- [ ] `예외처리` 등록 이름이 공백일 경우 예외가 발생한다
- [ ] `예외처리` 등록 가격이 1보다 작을 경우 예외가 발생한다
- [ ] `예외처리` 등록 가격이 1,000,000보다 클 경우 예외가 발생한다
- [ ] `예외처리` 등록 수량이 1보다 작을 경우 예외가 발생한다
- [ ] `예외처리` 등록 수량이 1,000,000보다 클 경우 예외가 발생한다
