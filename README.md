...
- [ ] `예외처리` 분리한 배열 요소가 공백일 경우 예외가 발생한다

---
### ✅ 상품 등록 기능
- [x] 상품 정보 리스트로 상품을 등록한다
- [x] 전체 상품 정보 리스트로 여러 상품을 등록한다
- [ ] `예외처리` 상품 정보 리스트 크기가 4가 아닌 경우 예외가 발생한다
- [ ] `예외처리` 등록 가격이 숫자가 아닌 경우 예외가 발생한다
- [ ] `예외처리` 등록 가격이 최소보다 작을 경우 예외가 발생한다 `최소 : 1`
- [ ] `예외처리` 등록 가격이 최대보다 클 경우 예외가 발생한다 `최대 : 1,000,000`
- [ ] `예외처리` 등록 수량이 숫자가 아닌 경우 예외가 발생한다
- [ ] `예외처리` 등록 수량이 최소보다 작을 경우 예외가 발생한다 `최소 : 1`
- [ ] `예외처리` 등록 수량이 최대보다 클 경우 예외가 발생한다 `최대 : 1,000,000`
